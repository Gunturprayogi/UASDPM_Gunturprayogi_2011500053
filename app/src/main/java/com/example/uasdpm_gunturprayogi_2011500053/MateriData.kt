package com.example.uasdpm_gunturprayogi_2011500053

import android.os.Bundle
import android.widget.*
import androidx.appcompat.app.AppCompatActivity

class MateriData : AppCompatActivity () {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val etNIDN = findViewById<EditText>(R.id.etNIMDSN)
        ...
        btnSimpan.setOnClickListener {
            if ("${etNIDN.text}".isNotEmpty() && "${etNmDosen.text}".isNotEmpty()&&
                ...
                val db = kampuss(this@PengentriDataPengajar)
                db.NIDN = "${etNIDN.text}"
